...
public class Sessions extends DBQuery
{
	...
	if(sessions.first())
	{
		...
		{					
			...
			DoQuery("INSERT INTO Log (IDUser,Provider,Login,Logout,IPUser, IPProvider, IDKarte) VALUES ("
			+sessions.getString("Username")+"'"
			+",'"+sessions.getString("Provider")+"'"
			+",'"+sessions.getString("Zeit")+"'"
			+",'"+sessions.getString("Endzeit")+"'"
			+",'"+sessions.getString("IP")+"'"
			+",'"+sessions.getString("RouterIP")+"'"
			+",'"+sessions.getString("IDKarte")+"'"
			+")");
